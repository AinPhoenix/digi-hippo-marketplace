        ...
        <div className="mt-4 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          <div
            className={cn("lg:col-span-7", {
              "rounded-lg border-2 border-dashed border-neutral-200 p-12":
                    ...
                    <li key={product.id} className="flex py-6 sm:py-10">
                      ...
                      <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                        ...
                        <p className="mt-4 flex space-x-2 text-sm text-neutral-700">
                          ...
                          <span>Eligibal for instant delivery</span>
                        </p>
                      </div>
                    </li>
                  );
          ...
          <section className="mt-16 rounded-lg bg-neutral-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
